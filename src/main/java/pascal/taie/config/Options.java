...
public class Options implements Serializable {
    ...
    @JsonProperty
    @Option(names = {"-lcs", "--lcs_threshold"},
            description = "the threshold when de-dup gadget chains")
    private double LCS_THRESHOLD;

    public double getLCS_THRESHOLD() {
        return LCS_THRESHOLD;
    }

    @JsonProperty
    @Option(names = {"-smt", "--SINK_MAX_TIME"},
            description = "the max collecting time of gadget chains per sink")
    private int SINK_MAX_TIME;

    public int getSINK_MAX_TIME() {
        return SINK_MAX_TIME;
    }

    @JsonProperty
    @Option(names = {"-pct", "--PATH_COLLECT_TIME"},
            description = "the max time of collecting paths")
    private int GCGraph_COLLECT_TIME;

    public int getGCGraph_COLLECT_TIME() {
        return GCGraph_COLLECT_TIME;
    }

    @JsonProperty
    @Option(names = {"-ici", "--IS_COLLECTGC_INPROCESS"},
            description = "collect gc whether in process")
    private boolean COLLECT_GC_INPROCESS;

    public boolean isCOLLECTGC_INPROCESS() {
        return COLLECT_GC_INPROCESS;
    }
